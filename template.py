import os   #This os module helps in operating system,folder structure,files to operate
from pathlib import Path

project_name = "src"    #we want a src folder that have all source codes or contain components
